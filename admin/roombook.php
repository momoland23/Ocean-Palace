...
<?php
	...
	if($f1=="NO" )
	{
	echo "<script type='text/javascript'> alert('Sorry! Superior Room Not Available')</script>";
	}
	else if($f2 =="NO")
	{
	echo "<script type='text/javascript'> alert('Sorry! Guest House Not Available')</script>";

	}
	else if ($f3 == "NO")
	{
	echo "<script type='text/javascript'> alert('Sorry! Single Room Not Available')</script>";
	}
	else if($f4=="NO")
	{
