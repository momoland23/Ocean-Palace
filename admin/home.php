...
<head>
    ...
    <title>Admin Ocean Palace</title>
    <!-- Bootstrap Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="home.php"><i class="fa fa-dashboard"></i> Room Booking</a>
                    </li>
                    <li>
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        Room Booking <small> Status </small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
