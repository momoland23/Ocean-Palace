...
$rooms = fetchRooms($con, $start, $limit);
$total_pages = ceil(countRooms($con) / $limit);
?>
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                <li><a href="settings.php"><i class="fa fa-dashboard"></i>Rooms Status</a></li>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <?php while ($row = mysqli_fetch_array($rooms)) : ?>
                                                    <tr class="<?php echo ($row['id'] % 2 == 0) ? 'odd gradeX' : 'even gradeC'; ?>">
