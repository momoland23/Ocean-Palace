            ...
            <div id="page-inner">
                    <div class="row">
                     ...
                     <!-- fetching from database-->               
                        ...
                        // Separate rooms based on their types
                        $superiorRooms = [];
                        $deluxeRooms = [];
                        $guestHouseRooms = [];
                        $singleRooms = [];
                        ...
                        while ($row = mysqli_fetch_array($re)) {
                            ...
                            if ($id == "Superior Room") {
                                $superiorRooms[] = $row;
                            } elseif ($id == "Deluxe Room") {
                                $deluxeRooms[] = $row;
                            } elseif ($id == "Guest House") {
                                $guestHouseRooms[] = $row;
                            } elseif ($id == "Single Room") {
                                $singleRooms[] = $row;
                            } 
                        }
                    ?>
                    ...
                    <div class="row">
                        ...
                        <?php foreach ($singleRooms as $row) : ?>
                        ...
                        <?php endforeach; ?>
                            ...
                            <!-- Display Superior Rooms -->
                        <?php foreach ($superiorRooms as $row) : ?>
                            <div class='col-md-3 col-sm-12 col-xs-12'>
                        ...
                        <!-- Display deluxe room -->
                        <?php foreach ($deluxeRooms as $row) : ?>
                            <div class='col-md-3 col-sm-12 col-xs-12'>
                        ...
                        <!-- Display guest room -->
                        <?php foreach ($guestHouseRooms as $row) : ?>
                            <div class='col-md-3 col-sm-12 col-xs-12'>
