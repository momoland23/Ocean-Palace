...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+99234561390</li>	
				</ul>
			</div>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">OCEAN <span> PALACE</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
					...
					<li>
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								...
								<h4>OCEAN PALACE</h4>
								<h3 style="color: black;">We know what you love!</h3>
								<p><b>Welcome to our hotel</b></p>
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top1">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>OCEAN PALACE</h4>
									<h3 style="color: black;">Stay with friends & families.</h3>
										<p style="color: white;"> <b>Come & enjoy precious moment with us.</b></p>
									<div class="agileits_w3layouts_more menu__item"> </div>
								</div>	
							</div>
						</div>
						...
						<div class="w3layouts-banner-top w3layouts-banner-top2">
							<div class="container">
								...
								<h3>Want luxurious vacation?</h3>
										<p style="color: white;"><b>Get accommodation today!</b></p>
									<div class="agileits_w3layouts_more menu__item"> </div>
								</div>
							</div>
						</div>
	...
	<div class="banner-bottom">
		<div class="container">	
			<div class="agileits_banner_bottom">
				<h3><span>Experience a comfortable stay ensuring a hassle-free experience with intuitive design .</h3>
			</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">OCEAN PALACE</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">ABOUT OUR OCEAN PALACE</h3> 
						   ...
						   <div class=" mt-4 mb-3 agileits_banner_bottom">
	...
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<h4>Syed Sadman</h4>
							<span>Manager</span>
							<p>Syed Sadman is one of the founding members of Ocean Palace Site, bringing an innovative approach to the Hotel Management industry. With a keen eye for detail, he navigates challenges to maintain a smooth and efficient booking platform, creating a positive experience for users.</p>
					...
					<div class="tab2">
						...
						<div class="col-md-6 team-Info-agileits">
						<h4>Mehzabin Afroz</h4>
							<span>Product Manager</span>
							<p>Mehzabin, a dedicated Product Manager at a hotel booking site, drives innovation and user experience. With a passion for creating seamless online journeys, she collaborates with teams to enhance features and optimize the platform.</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
...
function scrollToReviews() {
    var reviewsContainer = document.getElementById('display-reviews-container');
	...
	<div class="container">
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile2" data-aos="flip-left">
			<div class="contact-agileits">
				<h4>Contact Us</h4>
				<p class="contact-agile2">Mail For Queries</p>
				<form  method="post" name="sentMessage" id="contactForm" >
                    ...
                    <div class="control-group form-group">
                            ...
                            <label class="contact-p1">Contact Number:</label>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Contact :</strong>++99234561390</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">info@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Laboni Beach Road, Cox's Bazar, Bangladesh</p>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d10504.637874559516!2d91.97182366728397!3d21.431196941322447!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30adc943bbb5a5cf%3A0xa5fa353e10cafd6f!2sJol%20Torongo!5e0!3m2!1sen!2sbd!4v1705010413731!5m2!1sen!2sbd" ></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© All Rights Reserved by OCEAN PALACE Site's Owner. </a> </p>
		    </div>
<!--/footer -->
<!-- js -->
